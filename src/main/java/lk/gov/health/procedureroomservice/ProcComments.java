 ...
 */
@Entity
public class ProcComments implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProcComments)) {
            return false;
        }
        ProcComments other = (ProcComments) object;
    ...
    public String toString() {
        return "lk.gov.health.procedureroomservice.ProcComments[ id=" + id + " ]";
    }
