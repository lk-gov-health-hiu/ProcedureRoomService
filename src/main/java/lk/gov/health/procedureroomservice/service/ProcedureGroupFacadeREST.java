...
public class ProcedureGroupFacadeREST extends AbstractFacade<ProcedureGroup> {
    ...
    public ProcedureGroup find(@PathParam("id") Long id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<ProcedureGroup> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<ProcedureGroup> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
